...
namespace FluentValidation {
	...
	public interface IRuleBuilder<T, out TProperty> {
		...
		/// <returns></returns>
		IRuleBuilderOptions<T, TProperty, TValidator> SetValidator<TValidator>(TValidator validator) where TValidator : IPropertyValidator<T,TProperty>;
		...
		/// <param name="validator">The validator to set</param>
		/// <returns></returns>
		IRuleBuilderOptions<T, TProperty, TValidator> SetAsyncValidator<TValidator>(TValidator validator) where TValidator : IAsyncPropertyValidator<T,TProperty>;
	...
	public interface IRuleBuilderOptions<T, out TProperty, TValidator> : IRuleBuilder<T,TProperty>, IRuleBuilderOptions<T,TProperty> {
