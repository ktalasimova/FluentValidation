...
namespace FluentValidation.Validators {
	...
	[Obsolete("Regex-based email validation is not recommended and is no longer supported.")]
	public class EmailValidator<T> : PropertyValidator<T,string>, IRegularExpressionValidator, IEmailValidator<T>, IEmailValidator {
	...
	public class AspNetCoreCompatibleEmailValidator<T> : PropertyValidator<T,string>, IEmailValidator<T>, IEmailValidator {
	...
	public interface IEmailValidator<T> : IPropertyValidator<T, string> { }
